...
if (videoMotion.length > 0) {
    ...
    // biliDynlist = document.getElementsByClassName('bili-dyn-list__item')
    // for (const videoInfoData of biliDynlist){
    //     title =videoInfoData.querySelector("div:nth-child(2) > div > div > div.bili-dyn-item__header > div.bili-dyn-title > span").innerText
    //     generationVideoCard()
    // }
    dynList.remove()
    rightDom[0].remove()
